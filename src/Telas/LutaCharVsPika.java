 ...
 * @author pejoo
 */
public class LutaCharVsPika extends javax.swing.JFrame {

    public LutaCharVsPika() {
            ...
            public void run() {
                for (int i = 101; i > 0; i--) {
                    ...
                    try {
                        sleep(100);
                        if (i == 20){
                            CharmanderVsPikachu login = new CharmanderVsPikachu();
    ...
    private void initComponents() {
        ...
        jPanel1.add(VidaPika, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 80, 240, 10));
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 380, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LutaCharVsPika.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LutaCharVsPika().setVisible(true);
            }
        });
    }
