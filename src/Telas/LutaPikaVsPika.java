 ...
 * @author pejoo
 */
public class LutaPikaVsPika extends javax.swing.JFrame {

    /**
     * Creates new form LutaPikaVsPika
     */
    public LutaPikaVsPika() {
        initComponents();
                new Thread() {
            @Override
            public void run() {
                for (int i = 101; i > 0; i--) {
                    ...
                    try {
                        sleep(100);
                        if (i == 20){
                            PikachuVsPikachu login = new PikachuVsPikachu();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Ataque : Discharge");
        ...
        jLabel11.setText("Ataque: Agility");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/PikaContra.gif"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LutaPikaVsPika.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LutaPikaVsPika().setVisible(true);
            }
        });
    }
